                            ...
                            <Form className="w-full">
                                <div className="flex items-start justify-start flex-col mb-6 group">
                                    ...
                                    <Field
                                        ...
                                        name="email"
                                        type="email" 
                                        className={`${inter.className} block w-full duration-500 bg-[transparent] h-10 px-4 border border-white-100 text-sm text-white-400 rounded-full bg-white outline-none mb-3 focus:border-primary-400`}
                                    />
                                    <ErrorMessage
                                        className={`${inter.className} text-red-400 text-xs font-bold`}
                                        name="email"
                                        component="span"
                                    />
                                </div>
                                ...
                                <div className="flex items-center justify-end">
                                    <Link
                                        ...
                                        className={`${inter.className} text-sm text-primary-300 hover:underline`}
                                    >
                                        Esqueci minha senha
                                    </Link>
                                </div>
