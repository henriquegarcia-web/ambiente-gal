...
export default function PixelPage() {
    ...
    const columns = [
        ...
        { field: "idPixel", headerName: "idPixel", minWidth: 300, align: "center" },
        { field: "api", headerName: "Api", minWidth: 300, align: "center" },
    ...
    const handleFilter = (e) =>{
        ...
        let list  = listagem.filter((item)=>item.nome?.toLocaleLowerCase().includes(buscar.toLocaleLowerCase()) || item.idPixel?.toLocaleLowerCase().includes(buscar.toLocaleLowerCase()) || item.descricao?.toLocaleLowerCase().includes(buscar?.toLocaleLowerCase()) )
    ...
    return (
        <div className="flex items-start justify-start">
            ...
            <PixelForm disabled={disabled} buttonText={buttonText} listagem={listagem} setListagem={setListagem} modalActive={modalActive} setModalActive={setModalActive} item={item} setItem={setItem} />
        </div>
    );
}
